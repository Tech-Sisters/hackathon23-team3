    ...
    <div className="w-full">
      <div className="flex w-full py-3.5 pl-20">
        ...
        <div>
          ...
          >
            <option selected>Search for Movies, Books, and more... </option>
        ...
        <div>
          <button
            type="button"
            className="font-serif font-semibold ml-[350px] text-white bg-pink hover:bg-black focus:ring-4 focus:ring-blue-300 font-medium rounded-[4px] text-sm px-8 py-3 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
          >
            Login
          </button>
        </div>
